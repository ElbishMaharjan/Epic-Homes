...
import { deleteUser, test, updateUser, getUserListings, getUser } from '../controllers/user.controller.js'; // Import controller functions
...
router.get('/:id', verifyToken, getUser);                   // Define a route to handle GET requests with a parameter ':id',using the 'verifyToken' middleware to authenticate users,and the 'getUser' controller to handle the request.
