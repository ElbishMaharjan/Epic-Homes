...
import { createListing, deleteListing, updateListing, getListing, getListings } from '../controllers/listing.controller.js'; // Import the createListing function from the listing.controller module
...
router.get('/get', getListings);                      // Route to fetch listings data
