...
import Contact from '../components/Contact';                // Import the Contact component from the 'components' directory
import Map from '../components/map';                        // Importing the Map component with correct path
      ...
      {listing && (               // Check if 'listing' data is available
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            ...
            <div className='mt-6'>
              <Map address={listing.address} />              {/* Render the Map component with the address from the listing */}
            </div>
          </div>
        </div>
      )}
